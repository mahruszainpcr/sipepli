...
import { AppRegistry, StyleSheet, HeaderBackButton,TextInput, View, Alert, Text, Image,Platform, ActivityIndicator,ToastAndroid } from 'react-native';
      ...
      <Icon type="MaterialIcons" name="arrow-back" onPress={ () => {this.props.navigation.navigate('Login') } }  style={{marginTop:30,marginLeft:30,color:'#fff'}}/>
        ...
        <View style={styles.MainGambar}>
          ...
          <Item regular style={styles.FormInputStyleClass}>
            ...
            <Input placeholder='No Handphone' onChangeText={NoHpUser => this.setState({ NoHpUser })} placeholderTextColor='#fff' />
          </Item>
          ...
          <Item regular style={styles.FormInputStyleClass}>
            <Icon type="SimpleLineIcons" name="present" />
